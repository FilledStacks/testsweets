...
class CustomSolidBottomSheet extends StatefulWidget {
  ...
  const CustomSolidBottomSheet({
    ...
    this.minHeight = 0,
    this.maxHeight = 500,
    this.autoSwiped = false,
    this.toggleVisibilityOnTap = true,
    this.canUserSwipe = false,
...
class _CustomSolidBottomSheetState extends State<CustomSolidBottomSheet> {
  ...
  void initState() {
    ...
    widget.controller!.height =
        widget.showOnAppear ? widget.maxHeight : widget.minHeight;
