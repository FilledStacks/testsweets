...
class FindScrollablesImp implements FindScrollables {
  ...
  Iterable<ScrollableDescription> convertElementsToScrollDescriptions() {
    ...
    final extractedScrollableDescriptions = foundedElements!.map((item) {
      ...
      final rect = SerializableRect.fromPoints(globalPostion,
          globalPostion.translate(renderBox.size.width, renderBox.size.height));
